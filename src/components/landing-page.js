  ...
  render(){
    ...
    return(
      <main role='main' className='landing-page'>
        ...
        <img className='landing-logo' src={process.env.PUBLIC_URL + '/resources/overwatch-buddy-logo.png'} alt='Overwatch Buddy logo'></img>
        ...
        <p className='description'>
        For those looking to learn more about Blizzard's competitive shooter, 
        ...
        Overwatch Buddy is and will continue to be an incredible tool to propel you into the pro leagues!
        </p>
